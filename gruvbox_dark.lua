...
style.caret = { common.color "#FFDF00" }
style.accent = { common.color "#ebdbb2" }
style.dim = { common.color "#928374" }
style.divider = { common.color "#1d2021" }
style.selection = { common.color "#6a5acd" }
style.line_number = { common.color "#ebdbb2" }
style.line_number2 = { common.color "#fe5a1d" }
...
style.syntax["function"] = { common.color "#fd007f" }
